...
from thirdparty.BAGS.scene.colmap_loader import read_extrinsics_text, read_intrinsics_text, qvec2rotmat, \
    read_extrinsics_binary, read_intrinsics_binary, read_points3D_binary, read_points3D_text
from thirdparty.BAGS.utils.graphics_utils import getWorld2View2, focal2fov, fov2focal
import numpy as np
import json
from pathlib import Path
from plyfile import PlyData, PlyElement
from thirdparty.BAGS.utils.sh_utils import SH2RGB
from thirdparty.BAGS.scene.gaussian_model import BasicPointCloud
...
def readColmapSceneInfo(path, images, eval, llffhold=8):
    ...
    # ply_path = os.path.join(path, "sparse/0/rand3D.ply")
