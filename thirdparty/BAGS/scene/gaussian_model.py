...
import torch
import numpy as np
from thirdparty.BAGS.utils.general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation
from torch import nn
import os
from thirdparty.BAGS.utils.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from thirdparty.BAGS.utils.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from thirdparty.BAGS.utils.graphics_utils import BasicPointCloud
from thirdparty.BAGS.utils.general_utils import strip_symmetric, build_scaling_rotation
from .kernelnet_single_res import BlurKernel as BlurKernel_ss
from .kernelnet_multires import BlurKernel as BlurKernel_ms
...
class GaussianModel:
    ...
    def capture(self):
        return (
            ...
            self.mlp_rgb_ss.state_dict(),
            self.mlp_rgb_ms.state_dict(),
    ...
    def restore(self, model_args, training_args):
        ...
        self.mlp_rgb_ss.load_state_dict(mlp_ss_dict)
        self.mlp_rgb_ms.load_state_dict(mlp_ms_dict)
